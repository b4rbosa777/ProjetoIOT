...
namespace Estufa.Controllers
{
    ...
    public class UmidadeTerraController : ControllerBase
    {
        ...
        // GET: api/UmidadeTerra/5
        [HttpGet("{id}")]
        public async Task<ActionResult<UmidadeTerra>> GetUmidadeTerra(int id)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<UmidadeTerra>> PostUmidadeTerra(UmidadeTerra umidadeTerra)
        {
